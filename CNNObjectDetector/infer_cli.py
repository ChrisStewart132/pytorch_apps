"""
python infer_cli.py --model_path models/model_16f_v1.pth --video_path data/test.mp4
python infer_cli.py --model_path models/model_16f_v1.pth --video_path data/test.mp4 --save_video
"""
import argparse
import os
import cv2
...
import torch
from model import CNNObjectDetector
import numpy as np
import re
...
def run_inference(model_path, video_path, save_video=False, scale_factor=2): 
    ...
    model = CNNObjectDetector(3, 3, n_features=N_FEATURES) 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scale_factor", type=int, default=2, help="Scale factor for upsampling (optional, default: 2)") 
